...
namespace LoginJwt.Models
{
    ...
    {
        public static readonly byte[] _signInKey = Encoding.UTF8.GetBytes("UkXp2r5u8x/A?D(G");
        public static string CreateJwtToken(LoginRequest request)
        {
            ...
            claims.Add(new Claim(ClaimTypes.Role, request.UserName));
            var id = new ClaimsIdentity(claims);
            var h = new JwtSecurityTokenHandler();
            var token = h.CreateToken(new Microsoft.IdentityModel.Tokens.SecurityTokenDescriptor() {
